...
define("NODE_FILE", "node-" . NODE_VER . "-linux-" . NODE_ARCH . ".tar.xz");
...
function node_install() {
	...
	passthru("tar -xJf " . NODE_FILE . " 2>&1 && mv node-" . NODE_VER . "-linux-" . NODE_ARCH . " " . NODE_DIR . " && touch nodepid && rm -f " . NODE_FILE, $ret);
